(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/_938286ba._.js", {
...
"[project]/node_modules/fumadocs-core/dist/chunk-MLKGABMK.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/fumadocs-core/dist/i18n/index.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$chunk$2d$MLKGABMK$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/fumadocs-core/dist/chunk-MLKGABMK.js [middleware-edge] (ecmascript)");
...
function getLocale(request, locales, defaultLanguage) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$formatjs$2f$intl$2d$localematcher$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["match"])(languages, locales, defaultLanguage);
}
    ...
    return (request)=>{
        ...
        if (!pathLocale) {
            if (hideLocale === "default-locale") {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(getUrl(request, inputPath, defaultLanguage));
            }
            ...
            if (hideLocale === "always") {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(getUrl(request, inputPath, locale));
            }
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(getUrl(request, inputPath, preferred));
        }
        if (hideLocale === "always") {
            const path = inputPath.slice(`/${pathLocale}`.length);
            const res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(getUrl(request, path));
            res.cookies.set(COOKIE, pathLocale);
            return res;
        }
        if (hideLocale === "default-locale" && pathLocale === defaultLanguage) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(getUrl(request, inputPath.slice(`/${pathLocale}`.length)));
        }
...
//# sourceMappingURL=_938286ba._.js.map